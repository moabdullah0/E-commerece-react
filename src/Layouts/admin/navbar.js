  ...
  return (
    ...
    <nav className="flex-no-wrap relative flex w-full items-center justify-between bg-[#FBFBFB] py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4">
      <div className="flex w-full flex-wrap items-center justify-between px-3">
        ...
        >
          <Link to={'/dashboard'}
            className="mb-4 ml-2 mr-5 mt-3 flex items-center font-body scale-100 text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
            href="#"
          >
           MED <span className='text-yellow-400 mx-1 font-body scale-100'>Store Dashboard</span> 
          </Link>
