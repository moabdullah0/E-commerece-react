...
const Thankyou = () => {
  ...
  <div className="p-1 rounded shadow-lg bg-gradient-to-r from-purple-500 via-green-500 to-blue-500">
    <div className="flex flex-col items-center p-4 space-y-2 bg-white">
      ...
      <h1 className="text-4xl font-bold font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-700">
        { /* Use conditional rendering for the username */ }
        {userName} شكراً لك
      </h1>
      <p>Thank you for your interest! Check your email for a link to the guide.</p>
      <Link to={'/'}
        className="inline-flex items-center px-4 py-2 text-white bg-indigo-600 border border-blue-600 rounded rounded-full hover:bg-indigo-700 focus:outline-none focus:ring"
        >
